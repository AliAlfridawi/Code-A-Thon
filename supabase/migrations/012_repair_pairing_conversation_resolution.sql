-- =====================================================
-- Migration 012: Repair pairing conversation resolution
-- for pending, active, and archived chat entry points.
-- =====================================================
...
BEGIN
  ...
  IF v_pairing.mentor_clerk_user_id IS NOT NULL THEN
